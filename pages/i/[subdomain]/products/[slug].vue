<template>
  <div class="product-detail">
      ...
      <header class="detail-hero">
        <div class="container">
          <div class="breadcrumb">
            <NuxtLink :to="`/i/${subdomain}`">Home</NuxtLink>
            <el-icon><ArrowRight /></el-icon>
            <NuxtLink :to="`/i/${subdomain}/products`">Technologies</NuxtLink>
            <el-icon><ArrowRight /></el-icon>
        ...
        <aside class="side-actions">
          <div class="sticky-side">
            <div class="action-card">
              ...
              <el-button type="primary" class="contact-btn" @click="navigateTo(`/i/${subdomain}/contact`)">Request Technical Brief</el-button>
    ...
    <div v-else class="not-found container">
      ...
      <el-button type="primary" @click="navigateTo(`/i/${subdomain}/products`)">Back to Catalog</el-button>
    </div>
  </div>
</template>
...
const industrySiteData = inject<any>('industrySiteData')
const industryName = computed(() => industrySiteData.value?.industryName || 'Industry')
...
useSeoMeta({
  title: () => (product.value?.metaTitle || product.value?.name || 'Technology') + ' | ' + industryName.value,
