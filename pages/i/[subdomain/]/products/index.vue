  ...
  <div class="products-page">
    <header class="page-hero">
      ...
      <div class="container hero-content">
        <span class="tag">{{ industryName }} Portfolio</span>
        ...
        <article v-for="product in filteredProducts" :key="product.id" class="product-card">
          ...
          <div class="card-content">
            ...
            <div class="card-footer">
              <NuxtLink :to="`/i/${subdomain}/products/${product.slug}`" class="view-details">
                Technical Reference →
              </NuxtLink>
            </div>
          </div>
...
await useAsyncData(`industry-products-${subdomain.value}`, async () => {
...
useHead({
  title: computed(() => `Technology Catalog | ${industryName.value}`),
  meta: [
